  ...
  switch(state) {
    ...
    is(sIterate) {
      when(ctr_itr < 10.U) {
        ...
        val (y5, y9, y13, y1) = quater_round(matrix_4x4(1)(1), matrix_4x4(2)(1), matrix_4x4(3)(1), matrix_4x4(0)(1))
        val (y10, y14, y2, y6) = quater_round(matrix_4x4(2)(2), matrix_4x4(3)(2), matrix_4x4(0)(2), matrix_4x4(1)(2))
        val (y15, y3, y7, y11) = quater_round(matrix_4x4(3)(3), matrix_4x4(0)(3), matrix_4x4(1)(3), matrix_4x4(2)(3))
